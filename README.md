...
|`felddy/foundryvtt:11.300.0`| An exact image version. |
|`felddy/foundryvtt:11.300`| The most recent image matching the major and minor version numbers. |
...
| `FOUNDRY_DATA_DIR` | Set custom location of foundry data | `/data` |
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `11.300`                |
...
```console
docker build \
  --build-arg VERSION=11.300.0 \
  --tag felddy/foundryvtt:11.300.0 \
